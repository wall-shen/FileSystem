...
int main(){
   ...
   // FHandle* handle = loader -> OpenWrite("D:/data/qwe.pak", false);
   ...
   // FHandle* readHandle = loader -> OpenRead("D:/data/qwe.pak");
   // FReadArchive* rArchive = new FReadArchive(readHandle, "D:/data/qwe.pak", readHandle -> Size());
